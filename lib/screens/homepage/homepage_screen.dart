...
import 'package:note/screens/homepage/components/empty_notes.dart';

import 'package:note/screens/homepage/components/single_note.dart';
        ...
        child: Column(
          ...
          children: [
            const Padding(
              ...
              child: Text("Iris's note", style: kHeaderDarkTitle),
            ),
            Expanded(
